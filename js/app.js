(() => {
    ...
    function burgerMenu() {
        ...
        const btns = document.querySelector(".menu__btns");
    ...
    function fixedNav() {
        ...
        const breakpoint = 1;
        if (window.scrollY >= breakpoint) nav.classList.add("fixed__nav"); else nav.classList.remove("fixed__nav");
    }
    ...
    class Select {
        ...
        clickHandler(event) {
            ...
            if ("input" === type) this.toggle(); else if ("item" === type) {
